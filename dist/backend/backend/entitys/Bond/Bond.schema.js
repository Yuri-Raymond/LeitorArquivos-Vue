...
let Bond = class Bond extends mongoose_2.Document {
    constructor(id, nome, matricula, turma, disciplina, papel, inicio, termino, obs, status) {
        super();
        this.id = id;
        this.nome = nome;
...
exports.Bond = Bond = __decorate([
    ...
    __metadata("design:paramtypes", [String, String, String, String, String, String, Date, Date, Number, String])
], Bond);
