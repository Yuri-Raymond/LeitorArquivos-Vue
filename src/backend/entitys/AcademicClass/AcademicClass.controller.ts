...
import { AcademicClassService } from './AcademicClass.service'; // Importa o serviço corretamente

@Controller('generic') // Prefixo base da URL
export class AcademicClassController {
  constructor(private readonly service: AcademicClassService) {} // Injeta o serviço genérico
