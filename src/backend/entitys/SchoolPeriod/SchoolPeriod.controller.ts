...
import { SchoolPeriodService } from './SchoolPeriod.service'; // Importa o serviço corretamente

@Controller('generic') // Prefixo base da URL
export class SchoolPeriodController {
  constructor(private readonly service: SchoolPeriodService) {} // Injeta o serviço genérico
